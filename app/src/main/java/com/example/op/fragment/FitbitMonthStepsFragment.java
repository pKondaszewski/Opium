...
public class FitbitMonthStepsFragment extends Fragment {

    private static final int monthValue = 30;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        List<FitbitStepsData> stepsData = database.fitbitStepsDataDao().getHighestFitbitStepsDataValueByEveryDate(30);
        BarData barData;
