...
public class UserFeelingsProcessor extends FuzzyLogicProcessor {
    ...
    private final List<TreeMap<Double, Double>> moodTherms, answerTherms;
    ...
    public UserFeelingsProcessor(Double moodValue, Double answerValue) {
        ...
        therm4 = new TreeMap<>();
        therm5 = new TreeMap<>();
        moodTherms = List.of(therm1, therm2, therm3, therm4, therm5);

        therm11 = new TreeMap<>();
        therm22 = new TreeMap<>();
        answerTherms = List.of(therm11, therm22);
    }

    @Override
    public Double process() {
        URL moodResource = ExpertSystem.class.getResource("/therms/mood.csv");
        URL answerResource = ExpertSystem.class.getResource("/therms/answer.csv");
        fillTherms(moodTherms, moodResource, moodTherms.size());
        fillTherms(answerTherms, answerResource, answerTherms.size());
